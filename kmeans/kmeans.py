...
class kmeans(ScriptedLoadableModule):
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, 'kmeans1.png'),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        fileNames='kmeans1.nrrd',
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        category='kmeans',
        sampleName='kmeans2',
        thumbnailFileName=os.path.join(iconsPath, 'kmeans2.png'),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames='kmeans2.nrrd',
...
class kmeansWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath('UI/kmeans.ui'))
...
class kmeansLogic(ScriptedLoadableModuleLogic):
...
class kmeansTest(ScriptedLoadableModuleTest):
    """
    ...
    def test_kmeans1(self):
        ...
        import SampleData
        registerSampleData()
        inputVolume = SampleData.downloadSample('kmeans1')
